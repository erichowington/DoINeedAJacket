    ...
    <div className="App">
      <header className="App-header">
        ...
        <div>
          ...
          <button className="button" onClick={searchPressed}>
            Search
          </button>
        </div>
        {/* Answer */}
        ...
        <p className="temp">
          {" "}
          {weather.main?.temp &&
            "It is currently " + Math.floor(weather.main?.temp) + "° in"}{" "}
          {weather.name}{" "}
        </p>
      </header>
      <JacketModal
        weather={weather}
        handleJacketModal={handleJacketModal}
        jacketModalImg={jacketModalImg}
      />
