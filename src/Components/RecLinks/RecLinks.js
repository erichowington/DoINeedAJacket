        ...
        <>
          <div className="rec-links-modal">
            ...
            <div className="rec-links-content">
              <img className="jack-graf"src="./images/jacket-recs.png"/>
              <ul className="Heavy">
                Heavy Jackets
                ...
                <a href="https://arcteryx.com/us/en/shop/mens/thorium-sv-hoody?cmpid=pm|mult|perf|google|Arc%27teryx_Google-PMAX_S22_Performance_BOF_R:NAM_C:USA_L:EN|All_Products||{ad_id}&utm_source=google&utm_medium=pm|mult|perf&utm_campaign=Arc%27teryx_Google-PMAX_S22_Performance_BOF_R:NAM_C:USA_L:EN&gclsrc=aw.ds&gad_source=1&gclid=CjwKCAiA_tuuBhAUEiwAvxkgTrzsjWMKvERajkWRvcHru-X9M0KZx5mCH64CaKicx6kzX4m0baB7qBoCoL0QAvD_BwE" target="blank">
                  <li className="rec">Arcteryx: Thorium</li>
                </a>
                <a href="https://www.uniqlo.com/us/en/products/E449723-000/00?colorDisplayCode=09&sizeDisplayCode=004&gad_source=1&gclid=CjwKCAiA_tuuBhAUEiwAvxkgTl5PECD2NotRShYUWq4JRBFOFjkk452AsZ5OwBoO5IJ8cGwuj6fWFBoC9X8QAvD_BwE" target="blank">
                  <li className="rec">Uniqlo: Hybrid Parka</li>
                </a>
              </ul>
              <ul className="Medium">
                Medium Jackets
                <a href="https://www.mountainhardwear.com/p/mens-ghost-whisperer%2F2-hoody-1874761.html?dwvar_1874761_color=859" target="blank">
                  <li className="rec">Mountain Hardwear: Ghost Whisperer</li>
                </a>
                <a href="https://www.patagonia.com/product/mens-down-sweater-jacket/84675.html?dwvar_84675_color=NUVG&cgid=jackets" target="blank">
                  <li className="rec">Patagonia: Down Sweater</li>
                </a>
                <a href="https://adsumnyc.com/collections/outerwear/products/adsum-noroll-reflectaroll-down-jacket" target="blank">
                  <li className="rec">Adsum + NOROLL Reflectaroll Down Jacket</li>
                </a>
              </ul>
              <ul className="Light">
                Light Jackets
                <a href="https://us.carhartt-wip.com/products/og-chore-coat-blue-rigid-1545" target="blank">
                  <li className="rec">Carhartt WIP: OG Chore Coat</li>
                </a>
                <a href="https://www.stussy.com/collections/outerwear/products/1110224-zip-sherpa-shadow-plaid-black" target="blank">
                  <li className="rec">Stussy: Zip Sherpa Shadow Plaid</li>
                </a>
                <a href="https://arcteryx.com/us/en/shop/mens/squamish-hoody?cmpid=pm|mult|perf|google|Arc%27teryx_Google-PMAX_Non-Brand_S23_Performance_BOF_R:NAM_C:USA_L:EN|All_Products||{ad_id}&utm_source=google&utm_medium=pm|mult|perf&utm_campaign=Arc%27teryx_Google-PMAX_Non-Brand_S23_Performance_BOF_R:NAM_C:USA_L:EN&gclsrc=aw.ds&gad_source=1&gclid=CjwKCAiA_tuuBhAUEiwAvxkgTlyFdvTuzE-z61Jg-HBCmMVRyFi0Lr-XAbWvPEOoOJ7Xxa2qC25XjRoCVAIQAvD_BwE" target="blank">
